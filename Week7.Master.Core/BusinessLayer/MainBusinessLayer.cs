...
namespace Week7.Master.Core.BusinessLayer
{
    public class MainBusinessLayer : IBusinessLayer
    {
        ...
        public string InserisciNuovoDocente(Docente nuovoDocente)
        {
            ...
            docentiRepo.Add(docenteEsistente);
        ...
        public string ModificaDocente(int idDocenteDaModificare, string nuovaEmail, string nuovoNumeroTelefono)
        {
            ...
            if (docente == null)
            {
                return "Id docente errato o inesistente";
            }
            docentiRepo.Update(docente);
            return "Email e numero di telefono aggiornati correttamente";
        }
        ...
        {
            var docente = docentiRepo.GetById(idDocenteDaEliminare);
            if (docente == null)
            {
                return "Id docente errato o inesistente";
            }
        ...
        { 
            //non c'è controllo ma richiama la lista prensente su mock con il metodo CRUD al suo interno
