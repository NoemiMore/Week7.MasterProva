...
namespace Week7.Master.MCV
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // configurazione indempenndence injection 
            services.AddTransient<IBusinessLayer, MainBusinessLayer>(); //mi serve il core
            services.AddTransient<IRepositoryCorsi, RepositoryCorsiMock>();// specificare i repository reali da utilizzare
